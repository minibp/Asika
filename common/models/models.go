...
type MergeQueueConfig struct {
    ...
    CoreContributors  []string `json:"core_contributors"`
}
...
type SpamConfig struct {
    ...
    TriggerOnAuthor           bool     `json:"trigger_on_author"`
    TriggerOnSimilarTitle    bool     `json:"trigger_on_similar_title"`
    TitleSimilarityThreshold float64  `json:"title_similarity_threshold"`
    TriggerOnKeywords        []string `json:"trigger_on_keywords"`
}
...
// RepoGroupConfig represents repository group configuration
